...
\subsection{Fun Specification}
To embed the Fun specifcation within the web-application we utilise Bootstrap's Nav-tabs class to create list of tabs that allow the user to navigate through each section of the specification, as illustrated in Figure \ref{fig:implspec}.

\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[scale=0.35]{images/implspec1.png}
		\caption{Monolithic architecture}
		\label{fig:mono}
	\end{subfigure}
	~
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[scale=0.35]{images/implspec2.png}
		\caption{Micro-service architecture}
		\label{fig:micro}
	\end{subfigure}
	\caption{Monolithic vs. micro-service architecture}\label{fig:implspec}	
\end{figure}
