...
The Fun programming language has a \textit{\textbf{flat block structure}}. A flat block structure means that variables can have either a local or a global scope, and that the same identifier may be used to declare a local and a global variable. [Add more here...].
